...
import type { FSASDetail, RecommendationDetail } from "@/types/api";

interface FMScoreCardProps {
...
export default function FMScoreCard({ fsas, recommendation }: FMScoreCardProps) {
      ...
      {fsas || displayScore != null ? (
        ...
        <div className="text-center py-8">
          <p className="text-sm text-slate-400">
            FM alignment not computed for this fund
          </p>
          <p className="text-xs text-slate-400 mt-1">
            Run the scoring pipeline to generate FM alignment scores
          </p>
        </div>
      )}
    </div>
